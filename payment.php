                ...
                <div class="content">
                    <div class="container callout standard">
                        ...
                        <div class="twelve columns">
                            <h4>Payment</h4>
                            <p class="link-location">You are here: <a href="index.php">Home</a> / <a href="faq.php">Payment</a></p>
                        </div>
                    ...
                    <div class="container">
                        ...
                        <div class="fifteen columns">
                            <div class="sidebar-right" style="height: 70%;"> <!-- important if sidebar is on the right -->
                                
                                <br /><br />
                                <h5 class="title" Style="margin:20px 0 16px 18%; font-size:30px;">WELCOME PRERNA HEALTH CARE SERVICES</h5><br>
							

									<p Style="text-align: center; font-weight:bold;">Account Holder: Prerna Society of Technical Education and Research<br>

									A/C No. 916010037234426<br>

									Bank Name: Axis Bank Ltd.<br>

									IFS Code: UTIB0002951<br>

									Branch -Noida, UP-201301<br>
