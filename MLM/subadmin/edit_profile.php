				...
				<?php
                  ...
                  <div class="box-body">
                     <div class="form-group">
                      ...
                      <input type="text" class="form-control" value="<?php echo $row['member_id']; ?>" name="member_id" placeholder="Enter Member ID" readonly />
					  <input type="hidden" name="id" value="<?php echo $row['member_id']; ?>" />
                    </div>
					<div class="form-group">
                      <label>Member Name</label>
                      <input type="text" class="form-control" value="<?php echo $row['member_name']; ?>" name="member_name"  placeholder="Enter ..." readonly />
                    </div>
					<div class="form-group">
                      <label>Sponsor ID</label>
                      <input type="text" class="form-control" value="<?php echo $row['sponsor_id']; ?>"   placeholder="Enter Introduer ID " readonly />
                    </div>
					<div class="form-group">
                      <label>Sponsor Name</label>
                      <input type="text" class="form-control"  value="<?php echo $row['sponsor_name']; ?>" placeholder="Enter Introduer Name" readonly />
                    </div>
				<!--	<div class="form-group">
                      <label>Upliner ID</label>
                      <input type="text" class="form-control" value="<?php echo $row['sponsor_id']; ?>"  placeholder="Enter ..." readonly />
                    </div>
					<div class="form-group">
                      <label>Upliner Name</label>
                      <input type="text" class="form-control" value="<?php echo $row['sponsor_name']; ?>"  placeholder="Enter ..." readonly />
                    </div>  -->
					<div class="form-group">
                      <label>D.O.J</label>
                      <input type="text" class="form-control" value="<?php echo $row['doj']; ?>"  placeholder="Enter ..." readonly />
                    </div>
