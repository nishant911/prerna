              ...
              <div class="small-box bg-yellow">
                <div class="inner">
                  <?php
                    ...
                    $debit = $row_debit['value_debit'];
                    $d = $row_wallet['value_sum'] - $debit;

                    $query_business = "select sum(epin_value) as business_value from epin_create where epin='$_SESSION[member_id]' or member_id='$_SESSION[member_id]'";
                    $result_business = mysqli_query($con, $query_business);
                    $row_business = mysqli_fetch_array($result_business);
					mysqli_close($con);
                  ?>
                  <h3><?php  echo $row_business['business_value']; ?></h3>
                  <p>My Business</p>
                </div>
