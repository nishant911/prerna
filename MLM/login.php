...
<body>
	...
	?>
	<?php
		if( !empty( $_REQUEST['MessageAdmin'] ) )
		{
				$msg = $_REQUEST['MessageAdmin'];
   		 		//echo sprintf( '<p>%s</p>', $_REQUEST['Message'] );
   				 echo '<script> alert("Please Login Through Admin Login Link \nhttp://prernahealthcare.org/MLM/admin/login.php"); </script>';
		}
	?>
