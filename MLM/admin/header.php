  ...
  $con = OpenCon();
	...
	?>
      ...
      <aside class="main-sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="search_user.php"><i class="fa fa-circle-o"></i> Edit Profile</a></li>
                <li><a href="search_bank_details.php"><i class="fa fa-circle-o"></i> Bank Details</a></li>
                <li><a href="search_ekyc.php"><i class="fa fa-circle-o"></i> KYC Document</a></li>
			         	<li><a href="members_details.php"><i class="fa fa-circle-o"></i> Members Details</a></li>  
              </ul>
            </li>
            <li class="treeview">
              <a href="#">
              ...
              <ul class="treeview-menu">
                <li><a href="search_my_direct.php"><i class="fa fa-circle-o"></i> My Direct</a></li>
                <li><a href="search_my_team.php"><i class="fa fa-circle-o"></i> My Team</a></li>
                <li><a href="search_my_level.php"><i class="fa fa-circle-o"></i> My Level</a></li>
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
				...
				<li><a href="search_epin.php"><i class="fa fa-circle-o"></i>Epin Details</a></li>
           ...
           <!-- <li class="treeview">
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                ...
                <li><a href="search_withdraw_report.php"><i class="fa fa-circle-o"></i> Withdraw Report</a></li>
                <li><a href="account_history.php"><i class="fa fa-circle-o"></i> Account History</a></li>
             <!--   <li><a href="total_income.php"><i class="fa fa-circle-o"></i> Total Income </a></li>
				<li><a href="search_member_total_income.php"><i class="fa fa-circle-o"></i> Members Total Income  </a></li> -->
              </ul>
            </li>
			<li class="treeview">
              <a href="#">
              ...
              <ul class="treeview-menu">
                <li><a href="add_product_list.php"><i class="fa fa-circle-o"></i> Add Product List </a></li> 
                <li><a href="search_product.php"><i class="fa fa-circle-o"></i> Product </a></li>
              </ul>
            </li>
			<li class="treeview">
              <a href="#">
            ...
            <li class="treeview">
              <a href="#">
                <i class="fa fa-folder"></i> <span> Generate Card </span>
                <i class="fa fa-angle-left pull-right"></i>
              </a>
              <ul class="treeview-menu">
               <!-- <li><a href="send_query.php"><i class="fa fa-circle-o"></i> Send Message</a></li> -->
                <li><a href="generate_card.php"><i class="fa fa-circle-o"></i> Generate Card </a></li>
        ...
        <!--    <li class="treeview">
              <a href="#">
                <i class="fa fa-folder"></i> <span>Website Content</span>
                <i class="fa fa-angle-left pull-right"></i>
              </a>
              <ul class="treeview-menu">
                <li><a href="admin_home_page.php"><i class="fa fa-circle-o"></i> Home Page</a></li>
                <li><a href="admin_about_us.php"><i class="fa fa-circle-o"></i> About Us </a></li>
                <li><a href="admin_products.php"><i class="fa fa-circle-o"></i> Products</a></li>
                <li><a href="admin_photo_gallery.php"><i class="fa fa-circle-o"></i> Photo Gallery</a></li>
                <li><a href="admin_video_gallery.php"><i class="fa fa-circle-o"></i> Video Gallery</a></li>
                <li><a href="admin_clients.php"><i class="fa fa-circle-o"></i> Clients</a></li>
                <li><a href="admin_contactus.php"><i class="fa fa-circle-o"></i> Contact Us </a></li>
                <li><a href="admin_team.php"><i class="fa fa-circle-o"></i> Team </a></li>
                <li><a href="admin_latest_news.php"><i class="fa fa-circle-o"></i> Latest News </a></li>
