      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">Epin Details</li>
          </ol>
        </section>
            ...
            <div class="col-xs-12">
              ...
              <div class="box">
                <div class="box-header">
                  <h3 class="box-title">Epin Details Details</h3>
                </div><!-- /.box-header -->
                <div class="box-body">
                    ...
                    <thead>
                       ...
                       <tr
                                    ...
                                    <th class="sorting_desc" tabindex="0" aria-controls="tbl_data"
                                        ...
                                        rowspan="1" colspan="1"
                                        aria-label="Position: activate to sort column ascending"
                                        style="width: 32px;" aria-sort="descending">Product Name</th>
                                         <th class="sorting_desc" tabindex="0" aria-controls="tbl_data"
                                        rowspan="1" colspan="1"
                                        aria-label="Position: activate to sort column ascending"
                                        style="width: 32px;" aria-sort="descending">Created At</th>
                    </thead>
                    <tbody>
                     <?php
			$con = OpenCon();
            $member_id = $_POST['member_id'];         
						$query = "select * from epin_create where member_id='$member_id'";

						$result = mysqli_query($con, $query);
            $query_name = "select member_name from register where member_id='$member_id'";
