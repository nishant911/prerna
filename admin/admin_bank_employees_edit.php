    ...
    <div id="right-panel" class="right-panel">
        ...
        <div class="content mt-3">
            <div class="animated fadeIn">
                    ...
                    <div class="card">
                      <div class="card-header"><strong>Center</strong></div>
					   <?php
						...
						$i = $_GET['id'];
						$query_edit = "select * from admin_bank_employees where id='$i' ";
				...
				?>
					  <form name="forms" method="post" enctype="multipart/form-data" action="admin_bank_employees_edit_action.php" id="myForm">
						...
						<div class="row form-group">
                          <div class="col-6">
							...
							<input type="text" id="city" name="name" value="<?php echo $row_edit['name']; ?>" placeholder="Name" class="form-control" required></div>
                          </div>
                          <div class="col-6">
						...
						<div class="row form-group">
                          <div class="col-6">
							...
							<input type="text" id="city" name="bank_name" value="<?php echo $row_edit['bank_name']; ?>" placeholder="Enter Bank Name" class="form-control" required></div>
                          </div>
                          <div class="col-6">
                            <div class="form-group"><label for="postal-code" class=" form-control-label">Account Number</label>
							<input type="text" id="postal-code" value="<?php echo $row_edit['account_number']; ?>" name="account_number" placeholder="Enter Account Number" class="form-control" required></div>
                          </div>
                        </div>
						<div class="row form-group">
                          <div class="col-6">
                            <div class="form-group"><label for="city" class=" form-control-label">IFSC</label>
							<input type="text" id="city" name="ifsc_code" value="<?php echo $row_edit['ifsc_code']; ?>" placeholder="Enter IFSC Code" class="form-control" required ></div>
                          </div>
						  <div class="col-6">
                            <div class="form-group"><label for="city" class=" form-control-label">Branch</label>
							<input type="text" id="city" name="branch" value="<?php echo $row_edit['branch']; ?>" placeholder="Enter Branch" class="form-control" required></div>
                          </div>
                      ...
                      <?php 
							...
							?>
                              <tr>
								...
								<td><a href="admin_bank_employees_edit.php?id=<?php echo $row['id']; ?>"> Edit </a> </td>
