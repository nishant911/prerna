            ...
            <div class="animated fadeIn">
                ...
                <div class="row">
                  ...
                  <div class="col-lg-12">
                    <div class="card">
                      ...
                      <div class="card-body card-block">
						<form name="upload_excel" method="post" enctype="multipart/form-data" action="admin_upload_recent_event_action.php" id="myForm">
						<div class="col-6">
                          ...
                          <div class="col-6">
                            <div class="form-group"><label for="city" class=" form-control-label">Recent Events Heading</label>
							<input type="text" id="city" name="event_caption" placeholder="Recent Events Heading" class="form-control" required ></div>
                          </div>
                           
                        <div class="form-group"><label for="company" class=" form-control-label">Upload Image</label>
							<input type="file" id="company"  name="upload_event" placeholder="Enter Center Name" class="form-control" required ></div>
				  ...
				  <div class="col-md-12">
				   ...
				   <form name="forms" method="post" enctype="multipart/form-data" action="admin_upload_recent_event_delete.php" id="myForm">
                  <table  class="table table-striped table-bordered">
                    <thead>
                      <tr>
                        <th>S.no</th>
						 <th>Slider</th>
                        <th>Recent Events Heading</th>
                        <th>Image</th>
						<th>Select</th>
                    ...
                    <tbody>
							...
							?>
                              <tr>
								...
								<td><?php echo $row['event_caption']; ?></td>
								<td><a href="websiteupload/<?php echo $row['upload_event']; ?>" target="_blank" /> <?php echo $row['upload_event']; ?></td>
