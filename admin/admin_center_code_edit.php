        ...
        <div class="content mt-3">
            <div class="animated fadeIn">
				...
				<?php
						...
						$con = OpenCon();
						$i = $_GET['id'];
						$q = "select * from admin_center where id='$i' ";
				...
				?>
						<form name="forms" method="post" enctype="multipart/form-data" action="admin_center_code_edit_action.php" id="myForm">
                        <div class="form-group"><label for="company" class=" form-control-label">Center Name</label>
							<input type="text" id="company" value="<?php echo $row['center_name']; ?>" name="center_name" placeholder="Enter Center Name" class="form-control" required >
							<input type="hidden" value="<?php echo $i; ?>" name="id">
							</div>
                        <div class="form-group"><label for="vat" class=" form-control-label">Center Code</label>
							<input type="text" id="vat" value="<?php echo $row['center_code']; ?>" name="center_code" placeholder="E.g: UP/HR/BR-1101" class="form-control" required ></div>
				 ...
				 <div class="col-lg-6">
                    <div class="card">
						...
						<form name="forms" method="post" enctype="multipart/form-data" action="admin_center_code_delete_action.php" id="myForm">
                            <table class="table">
                              <thead>
                                <tr>
                          ...
                          <tbody>
							...
							?>
                              <tr>
								...
								<td><a href="admin_center_code_edit.php?id=<?php echo $row['id'];?>"> Edit </a> </td>
