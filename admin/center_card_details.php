                ...
                <div class="row">
                  ...
                  <div class="col-lg-12">
                    <div class="card">
					  ...
					  <form name="forms" method="post" enctype="multipart/form-data" action="center_card_details_action.php" id="myForm">
					       <div class="form-group"><label for="company" class=" form-control-label">Center Name</label>
						 <select name="center_name" id="select" class="form-control">
						...
						<div class="row form-group">
                          ...
                          <div class="col-6">
                            <div class="form-group"><label for="postal-code" class=" form-control-label">Pin Number</label>
							<input type="text" id="postal-code" name="card_number" placeholder="Card Number" class="form-control"></div>
                          </div>
                        </div>
