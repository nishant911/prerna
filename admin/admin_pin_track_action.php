...
<head>
	...
	<script>
		...
		/*function search(){
			var centername = document.getElementById("center_name");
			var name = centername.options[centername.selectedIndex].value;
			
			var centercode = document.getElementById("center_code");
			var code = centercode.options[centercode.selectedIndex].value;
			/*
			<?php $name = 'name';?>
			<?php $code = 'code';?>
