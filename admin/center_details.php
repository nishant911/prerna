        ...
        <div class="content mt-3">
                ...
                <div class="row">
                  ...
                  <div class="col-lg-12">
                    <div class="card">
					  ...
					  <form name="forms" method="post" enctype="multipart/form-data" action="center_details_action.php" id="myForm">
                      <div class="card-body card-block">
                        ...
                        <div class="form-group"><label for="company" class=" form-control-label">Center Code</label>
						 <select name="center_code" id="select" class="form-control" required >
                                ...
                                <?php
										$con = OpenCon();
										$res = mysqli_query($con, "SELECT center_name,center_code FROM admin_center where center_code='$_SESSION[center_code]'");
										mysqli_close($con);
                       ...
                       <div class="card-header"><strong>Other Details</strong></div> 
						...
						<div class="row form-group">
                          <div class="col-6">
							...
							<input type="text" id="city" name="mobile_number_o" placeholder="Mobile Number" class="form-control"></div>
                          </div>
                          <div class="col-6">
                      ...
                      <div class="card-body card-block">
						...
						<div class="row form-group">
                          ...
                          <div class="col-6">
							...
							<input type="text" id="postal-code" name="mobile_number" placeholder="Mobile Number" class="form-control"></div>
                          </div>
                        </div>
						<div class="row form-group">
                          <div class="col-6">
            ...
            <div class="animated fadeIn">
                ...
                <div class="col-md-12">
				   ...
				   <form name="forms" method="post" enctype="multipart/form-data" action="center_details_delete_action.php" id="myForm">
                  <table  class="table table-striped table-bordered">
                    ...
                    <tbody>
                      <?php 
								$con = OpenCon();
								$query = "select * from admin_center_details where center_code='$_SESSION[center_code]'";
