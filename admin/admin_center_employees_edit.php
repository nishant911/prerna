    ...
    <div id="right-panel" class="right-panel">
		...
		<div class="content mt-3">
            <div class="animated fadeIn">
                    ...
                    <div class="card">
                      ...
                      <div class="card-body card-block">
					   <?php
						...
						$con = OpenCon();
						$i = $_GET['id'];
						$query_edit = "select * from admin_center_employees where id='$i' ";
				...
				?>
						<form name="forms" method="post" enctype="multipart/form-data" action="admin_center_employees_edit_action.php" id="myForm">
                        <div class="form-group"><label for="company" class=" form-control-label">Center Name</label>
						 ...
						 <input type="hidden"name="id" value="<?php echo $row_edit['id']; ?>" ></div>
						 
                        <div class="form-group"><label for="vat" class=" form-control-label">Center Code</label>
						<input type="text" id="company" name="center_code" value="<?php echo $row_edit['center_code']; ?>" placeholder="Enter Username" class="form-control" readonly ></div>
						<div class="form-group"><label for="company" class=" form-control-label">Employee Name</label>
						<input type="text" id="company" name="employee_name" value="<?php echo $row_edit['employee_name']; ?>" placeholder="Enter Employee Name" class="form-control" required></div>
						
						<div class="form-group"><label for="company" class=" form-control-label">Date Of Joining</label>
						<input type="date" id="company" name="date_of_joining" value="<?php echo $row_edit['date_of_joining']; ?>" placeholder="" class="form-control" required ></div>
                        </br>
                          ...
                          <tbody>
							...
							?>
                              <tr>
								...
								<td><a href="admin_center_employees_edit.php?id=<?php echo $row['id']; ?>"> Edit </a> </td>
        ...
        <div class="content mt-3">
            <div class="animated fadeIn">
                    ...
                    <div class="card">
                      <div class="card-header"><strong>Center</strong></div>
					   <?php
						$i = $_GET['id'];
						$con = OpenCon();
						$query_edit = "select * from admin_center_employees_register where id='$i' ";
						$result_edit = mysqli_query($con,$query_edit);
						mysqli_close($con);
						$row_edit = mysqli_fetch_array($result_edit);
				...
				?>
					  <form name="forms" method="post" enctype="multipart/form-data" action="admin_center_employees_register_edit_action.php" id="myForm">
					    <div class="card-body card-block">
                        <div class="form-group"><label for="company" class=" form-control-label">Center Name</label>
						 <input type="text" id="company" name="center_name" value="<?php echo $row_edit['center_name']; ?>" placeholder="Enter Username" class="form-control" readonly >
						 <input type="hidden"name="id" value="<?php echo $row_edit['id']; ?>" ></div>
						...
						<div class="row form-group">
                          <div class="col-6">
							...
							<input type="text" name="name" id="city" value="<?php echo $row_edit['name']; ?>" placeholder="Name" class="form-control" required></div>
                          </div>
                          <div class="col-6">
                            <div class="form-group"><label for="postal-code" class=" form-control-label">Designation</label>
							<input type="text" name="designation" value="<?php echo $row_edit['designation']; ?>" id="postal-code" placeholder="Designation" class="form-control" required ></div>
                          </div>
                        </div>
						<div class="row form-group">
                          <div class="col-6">
                            <div class="form-group"><label for="city" class=" form-control-label">Employee Id</label>
							<input type="text" id="city" name="employee_id" value="<?php echo $row_edit['employee_id']; ?>" placeholder="Employee Id" class="form-control" required></div>
                          </div>
                          <div class="col-6">
                            <div class="form-group"><label for="postal-code" class=" form-control-label">Address</label>
							<input type="text" id="postal-code" name="address" value="<?php echo $row_edit['address']; ?>" placeholder="Address" class="form-control" required ></div>
                          </div>
                        </div>
						<div class="row form-group">
                          <div class="col-6">
                            <div class="form-group"><label for="city" class=" form-control-label">Email Id</label>
							<input type="text" id="city" name="email_id" value="<?php echo $row_edit['email_id']; ?>" placeholder="Email Id" class="form-control" required ></div>
                          </div>
						  <div class="col-6">
                            <div class="form-group"><label for="city" class=" form-control-label">Mobile Number</label>
							<input type="text" id="city" name="mobile_number" value="<?php echo $row_edit['mobile_number']; ?>" placeholder="Mobile Number" class="form-control" required ></div>
                          </div>
						...
						<div class="col-6">
							...
							<input type="date" id="city" name="doj" value="<?php echo $row_edit['doj']; ?>" placeholder="" class="form-control" required ></div>
                          </div>
                          <div class="col-6">
