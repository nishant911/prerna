        ...
        <div class="container">
            <div class="login-content">
                ...
                <div class="login-form">
                    <form name="forms" method="post" enctype="multipart/form-data" action="center_login_action.php" ><br><br>
						 
						 <div class="form-group">
                              <select  id="select" name="center_name" class="form-control">
                                <option value="0">Center Name</option>
                                <?php	include 'dbconnection.php';
										$con = OpenCon();
										$res = mysqli_query($con, "SELECT id,center_name FROM admin_center");
										mysqli_close($con);
										while($ro = mysqli_fetch_array($res))	{
										$center_name = $ro['center_name'];
						 ...
						 <div class="form-group">
                              <select  id="select" name="center_code" class="form-control">
