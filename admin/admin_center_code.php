                  ...
                  <div class="col-lg-6">
                    <div class="card">
                      ...
                      <div class="card-body card-block">
						<form name="forms" method="post" enctype="multipart/form-data" action="admin_center_code_action.php" id="myForm">
                        <div class="form-group"><label for="company" class=" form-control-label">Center Name</label>
							<input type="text" id="company" name="center_name" placeholder="Enter Center Name" class="form-control" required ></div>
                        <div class="form-group"><label for="vat" class=" form-control-label">Center Code</label>
							<input type="text" id="vat" name="center_code" placeholder="E.g: UP/HR/BR-1101" class="form-control" required ></div>
