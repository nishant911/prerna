                ...
                <div class="content">
                    <div class="container callout standard">
                        ...
                        <div class="twelve columns">
                            <h4>FAQ</h4>
                            <p class="link-location">You are here: <a href="index.php">Home</a> / <a href="faq.php">FAQ</a></p>
                        </div>
                        ...
                        <div class="fifteen columns">
                            <div class="sidebar-right"> <!-- important if sidebar is on the right -->
                                ...
                                <h5 class="title" Style="margin:20px 0 16px 18%; font-size:30px;">WELCOME PRERNA HEALTH CARE SERVICES</h5><br>
								 ...
								 <p Style="margin:20px 0 16px 5px; font-weight:bold;">Frequently Ask Question<br></p>
                                ...
                                <p Style="margin:20px 0 16px 5px; font-weight:bold;">
