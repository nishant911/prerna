				   ...
				   <?php
						...
						<h5> <?php echo $row['caption']; ?> </h5>
                            <figure class="effect-apollo">
                                <a class="example-image-link" href="admin/websiteupload/<?php echo $row['legals']; ?>" data-lightbox="example-set" download="admin/websiteupload/<?php echo $row['legals']; ?>"  title="ImageName">
                                    <img class="g_img" src="admin/websiteupload/<?php echo $row['legals']; ?>" alt="" />
                                    <figcaption>
                                       <p style="padding:0% 10% 5% 0%;">Click on image for download</p>
                                    </figcaption>   
                                </a>
                            </figure>
                        </div>
