                ...
                <div class="content">
                    <div class="container callout standard">
                        ...
                        <div class="twelve columns">
                            ...
                            <p class="link-location">You are here: <a href="index.php">Home</a> /<a href="doctor.php">Doctor</a></p>
                        </div>
                            ...
                            <div class="filter">
                                ...
                                <select name="state" id="search_box" class='search_box'>
											...
											<?php	include 'dbconnection.php';
													...
													$result = mysqli_query($con, "SELECT DISTINCT(state) FROM register where register_as='Doctor'");
													mysqli_close($con);
