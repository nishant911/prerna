...
<?php
    ...
    if(isset($_GET['search_word']))
    {
        ...
        $sql=mysqli_query($con, "SELECT * FROM register WHERE register_as='Hospital/Clinic' and state LIKE '%$search_word_fix%' and city LIKE '%$search_word_fix1%' ");
           ...
           echo "<section id='demos'>";		
            ...
            while($row = mysqli_fetch_array($sql)){
                                       ...
                                       echo "<div class='img border'>";
                                            echo "<img src='images/hospital.jpg' class='scale-with-grid' />";
