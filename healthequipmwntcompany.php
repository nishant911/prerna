...
<script type="text/javascript" src="http://ajax.googleapis.com/ajax/libs/jquery/1.3.0/jquery.min.js"></script>
    ...
    $.ajax({
    type: "GET",
    url: "searching_medical_eqipment_provider_company.php",
    data: dataString,
    cache: false,
...
$(document).ready(function()
{
	$(".search_box").change(function()
	{
		...
		({
			type: "POST",
			url: "health_eqipment_get_city.php",
			data: dataString,
			cache: false,
			success: function(html)
			{
        ...
        <div class="header">
            ...
            <div class="container">
                <div class="page-title">
                    <div class="rg"></div>
                    <h1>Find Health Equipmwnt Company</h1>
                </div>
            </div>
        </div>
                ...
                <div class="content">
                    <div class="container callout standard">
                        ...
                        <div class="twelve columns">
                            ...
                            <p class="link-location">You are here: <a href="index.php">Home</a> /<a href="hospital.php">Health Equipmwnt Company</a></p>
                        </div>
                            ...
                            <form method='post' action>
                                ...
                                <select name="state" id="search_box" class='search_box'>
											...
											<?php	include 'dbconnection.php';
													$con = OpenCon();
													$result = mysqli_query($con, "SELECT DISTINCT(state) FROM register where register_as='Medical Equipment Provider Company'");
													mysqli_close($con);
