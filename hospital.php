                ...
                <div class="content">
                    <div class="container callout standard">
                        ...
                        <div class="twelve columns">
                            ...
                            <p class="link-location">You are here: <a href="index.php">Home</a> /<a href="hospital.php">Hospitals</a></p>
                        </div>
                               ...
                               <h5>Search By:</h5>
                                <select name="state" id="search_box" class='search_box'>
											...
											<?php	include 'dbconnection.php';
													$con = OpenCon();
													$result = mysqli_query($con, "SELECT DISTINCT(state) FROM register where register_as='Hospital/Clinic'");
													mysqli_close($con);
