        ...
        <div class="header">
            ...
            <div class="container">
                <div class="page-title">
                    <div class="rg"></div>
                    <h1>PRERNA HEALTH CARD STATUS</h1>
                </div>
            </div>
        </div>
                    ...
                    <div class="container">
                       <div class="container callout standard">
                        ...
                        <div class="twelve columns">
                            <h4>CHECK CARD STATUS</h4>
                            <p class="link-location">You are here: <a href="index.php">Home</a> /<a href="status.php">Card Status</a></p>
                        </div>
                        ...
                        <div class="contact eleven columns">
                               ...
                               <form name="forms" method="post" enctype="multipart/form-data" action="" id="myForm" style="margin-bottom: 10%;">
								 <input type="text" id="card" class='search_box' name="search" placeholder="Enter Card Number">
								 <input type="submit" id="cardsubmit" class="search_button" value="Search">	
							   </form>
							   </div>
							   <div id="flash" >
							   </div>
                         <div class="contact eleven columns"  id="insert_search"> 
                        </div>
						 <div class="clear"></div>
