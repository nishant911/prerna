				   ...
				   <?php
                        ...
                        <div class="grid">
                            <figure class="effect-apollo">
                                ...
                                <a class="example-image-link" href="admin/websiteupload/<?php echo $row['photo_gallery']; ?>"  data-lightbox="example-set" >
                                    <img  class="g_img" src="admin/websiteupload/<?php echo $row['photo_gallery']; ?>" alt="" />
