...
<script type="text/javascript">
    ...
    $.ajax({
    type: "GET",
    url: "searching_diagnostic_pathlab.php",
    data: dataString,
    cache: false,
...
$(document).ready(function()
{
	$(".search_box").change(function()
	{
		...
		({
			type: "POST",
			url: "diagnostic_pathlab_get_city.php",
			data: dataString,
			cache: false,
			success: function(html)
			{
                ...
                <div class="content">
                    <div class="container callout standard">
                        ...
                        <div class="twelve columns">
                            ...
                            <p class="link-location">You are here: <a href="index.php">Home</a> /<a href="diagnostic_pathlab.php">Diagnostic/Pathlab</a></p>
                        </div>
                               ...
                               <form method='post' action>
                                ...
                                <select name="state" id="search_box" class='search_box'>
											...
											<?php	include 'dbconnection.php';
													...
													$result = mysqli_query($con, "SELECT DISTINCT(state) FROM register where register_as='Diagnostic/Pathlab'");
													mysqli_close($con);
