...
<?php
    ...
    if(isset($_GET['search_word']))
    {
        ...
        $sql=mysqli_query($con, "SELECT * FROM register WHERE register_as='Blood Bank' and state LIKE '%$search_word_fix%' and city LIKE '%$search_word_fix1%' ");
        ...
        if($count > 0)
        {
            ...
            while($row = mysqli_fetch_array($sql)){
                                       ...
                                       echo "<div class='img border'>";
                                            echo "<img src='images/bloodbank.jpg' class='scale-with-grid' />";
